    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.btn_move_with_data_activity;
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"Muhammad Haikal Firdaus");
            ...
            case R.id.btn_move_activity_object;
                ...
                mPerson.setName("Muhammad Haikal Firdaus");
                mPerson.setAge(17);
                mPerson.getEmail("haikal.firdaus.m@gmail.com");
                ...
                case R.id.btn_dial_number;
                    String phoneNumber = "081395885527";
